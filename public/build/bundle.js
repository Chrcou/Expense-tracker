...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th, file$3, 19, 8, 461);
    			add_location(td0, file$3, 22, 8, 519);
    			add_location(td1, file$3, 24, 8, 548);
    			add_location(td2, file$3, 25, 8, 583);
    			add_location(td3, file$3, 26, 8, 615);
    			add_location(td4, file$3, 27, 8, 645);
    			add_location(td5, file$3, 28, 8, 677);
    			add_location(tr, file$3, 18, 6, 448);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th0, file$3, 7, 6, 146);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$3, 8, 6, 175);
    			attr_dev(th2, "scope", "col");
    			add_location(th2, file$3, 9, 6, 207);
    			attr_dev(th3, "scope", "col");
    			add_location(th3, file$3, 10, 6, 247);
    			attr_dev(th4, "scope", "col");
    			add_location(th4, file$3, 11, 6, 283);
    			attr_dev(th5, "scope", "col");
    			add_location(th5, file$3, 12, 6, 317);
    			attr_dev(th6, "scope", "col");
    			add_location(th6, file$3, 13, 6, 353);
    			add_location(tr, file$3, 6, 4, 135);
    			add_location(thead, file$3, 5, 2, 123);
    			add_location(tbody, file$3, 16, 2, 406);
    			attr_dev(table, "class", "table table-striped");
    			add_location(table, file$3, 4, 0, 85);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h5, file$1, 12, 10, 304);
    			attr_dev(h6, "class", "card-subtitle mb-2 text-muted");
    			add_location(h6, file$1, 13, 10, 348);
    			attr_dev(p, "class", "card-text");
    			add_location(p, file$1, 14, 10, 418);
    			attr_dev(div0, "class", "card-body");
    			add_location(div0, file$1, 11, 8, 270);
    			attr_dev(div1, "class", "card");
    			set_style(div1, "width", "18rem");
    			add_location(div1, file$1, 10, 4, 221);
    			add_location(div2, file$1, 9, 0, 211);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*total*/ 1) set_data_dev(t4, /*total*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	store.subscribe(data => {
    		$$invalidate(0, total = data.reduce(
    			(acc, curr) => {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ExpenseTotal> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ store, total });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-q681sm");
    			add_location(h1, file, 12, 1, 395);
    			attr_dev(main, "class", "svelte-q681sm");
